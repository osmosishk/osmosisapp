...
function FollowupStack(props) {
  return (
    <Stack.Navigator initialRouteName="Follow Up" mode="card" headerMode="screen">
        <Stack.Screen
        name="Notifications"
        component={NotificationsStack}
        options={{
...
function AppStack(props) {
  return (
    ...
    >
      ...
      <Drawer.Screen name="Energy Profile" component={Register} />
      <Drawer.Screen name="Follow Up" component={FollowupStack} />
      <Drawer.Screen name="Events" component={ArticlesStack} />
      <Drawer.Screen name="Control" component={SettingsStack} />
    </Drawer.Navigator>
  );
}
